...
<a class="navbarColumn" href="popup_de_notificaciones_sin_hacer.php">Notificaciones</a> <!--javascript-->
<?php
  if($log==1){
    echo '<a class="navbarColumn" href="redirección_condicional_cancerbero_o_adminpage.php">Administrar</a>'; //función php
  }
?>
